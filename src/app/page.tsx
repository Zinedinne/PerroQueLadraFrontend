            ...
            */}
            ...
            <section className="py-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {/* Mostramos los eventos restantes (del segundo en adelante) */}
                {eventos.length > 1 ? eventos.slice(1, 3).map((evento: any) => {
                  ...
                  <p className="text-white/20 uppercase font-black text-xs tracking-widest col-span-2 text-center py-20 border border-white/5 rounded-3xl italic">
